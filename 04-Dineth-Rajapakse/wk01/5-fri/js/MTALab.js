...
// const lineN = function (stops) {
//         // lineN =  how do i loop the array through this function so that it returns the desired
// }; 

function isSameLine(line, startStation, endStation) {
        let tripLine = lines[line];
        let startIndex = lines[line].indexOf(startStation);
        let endIndex = lines[line].indexOf(endStation);
...
function isStartOrEndUnion(startLine, startStation, endLine, endStation) {
        ...
        if (startStation === "Union Square") {
          let msg = "You are travelling from " + startStation + " through to ";
          msg += endStation + " on the " + endLine + " line.";
          return msg;
        }
        let msg = "You are travelling from the " + startStation + " on the ";
